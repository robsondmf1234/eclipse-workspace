...
public class Test {
	...
	public static void main(String[] args) {
		...
		System.out.println(" Organizando por ordem natural.(Método compareTo ,foi implementado para ordenar por saldo ");
...
//Ordenação pelo numero da Agencia
